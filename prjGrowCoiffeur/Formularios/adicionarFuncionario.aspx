<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adicionarFuncionario.aspx.cs" Inherits="prjGrowCoiffeur.Formularios.adicionarFuncionario" %>
            ...
            <nav class="menu-lateral">
                ...
                <ul>
                   <li class="item-menu"><a href="Agendamentos.aspx"><span class="icon"><i class="bi bi-table"></i></span><span class="txt-link">Agendar</span><span class="icon-seta"><i class="bi bi-caret-right"></i></span></a></li>
                    ...
                    <li class="item-menu ativo"><a href="funcionario.aspx"><span class="icon"><i class="bi bi-people"></i></span><span class="txt-link">Funcionário</span><span class="icon-seta"><i class="bi bi-caret-right"></i></span></a></li>
              ...
              <div class="conteudo">
                ...
                <section class="areaFormulario">
                      ...
                      <p>
                        ...
                        <asp:TextBox ID="txtNome" runat="server" placeholder="Informe o Nome do Funcionário"></asp:TextBox>
                    </p>
                    ...
                    <p>
                     ...
                     <p>
                        ...
                        <asp:TextBox ID="txtEndereco" runat="server" placeholder="Informe o endereco completo do Funcionário"></asp:TextBox>
                    </p>
                    ...
                    <asp:TextBox ID="txtCPF" runat="server" placeholder="Informe o CPF do Funcionário"></asp:TextBox>
                </p>
                  
                   
                    <p class="btns">
                     <asp:Button ID="btnsalvar" runat="server" Text="Adicionar Funcionário" OnClick="btnsalvar_Click" />
                ...
                <script src="javascript/menu.js"></script>
                  <script src="mascaras/menu.js"></script>
