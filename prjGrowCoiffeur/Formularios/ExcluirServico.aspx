<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExcluirServico.aspx.cs" Inherits="prjGrowCoiffeur.Formularios.ExcluirServico" %>
            ...
            <div class="conteudo">
                ...
                <section class="areaFormulario">
                    <p>
                        ...
                        <asp:TextBox ID="txtCodigo" runat="server" placeholder="Digite o código" Disabled="" ReadOnly="true"></asp:TextBox>
                    </p>

                    <p>
                        <label for="txtNome">Nome:</label>
                        <asp:TextBox ID="txtNome" runat="server" placeholder="Informe nome do Serviço" Disabled="" autofocus=""></asp:TextBox>
                    </p>

                    <p>
                        <label for="txtPreco">Preço:</label>
                        <asp:TextBox ID="txtPreco" runat="server" placeholder="Informe valor unitário do serviço" Disabled=""></asp:TextBox>
                    </p>
                    ...
                    <p>
                        ...
                        <asp:TextBox ID="txtTempo" runat="server" placeholder="Informe o tempo do serviço" Disabled=""></asp:TextBox>
                    </p>

                    <p>
                        <label for="txtdata">Descrição do Serviço:</label>
                        <asp:TextBox ID="txtDescricao" runat="server" placeholder="Informe a descrição do serviço" Disabled=""></asp:TextBox>
                    </p>
