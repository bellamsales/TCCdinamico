<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdicionarServico.aspx.cs" Inherits="prjGrowCoiffeur.Formularios.servico" %>
            ...
            <div class="conteudo">
                ...
                <section class="areaFormulario">
                    ...
                    <p>
                        ...
                        <asp:TextBox ID="txtTempo" runat="server" placeholder="Informe o tempo do serviço"></asp:TextBox>
                    </p>
